    ...
    my @data = (
        {
            ...
            mock => [
                { tag      => [qw/0.1 0.3/] },
                { log      => "1414516991\x{1}31baa55db4c99774432b97ea5ec2784819a86079" },
                { log      => "1414516992\x{1}31baa55db4c99774432b97ea5ec2784819a86079" },
        ...
        },
        {
            ...
            mock => [
                { tag      => [qw/0.1 0.3/] },
                { log      => "1414516991\x{1}31baa55db4c99774432b97ea5ec2784819a86071" },
                { log      => "1414516992\x{1}31baa55db4c99774432b97ea5ec2784819a86072" },
                { 'rev-parse' => [qw/31baa55db4c99774432b97ea5ec2784819a86073 31baa55db4c99774432b97ea5ec2784819a86074/] },
                { log      => "1414516992\x{1}31baa55db4c99774432b97ea5ec2784819a86074" },
                { log      => "1414516993\x{1}31baa55db4c99774432b97ea5ec2784819a86073" },
            ],
            STD => {
